package com.lightbend.lagom.maven_archetype_lagom_java.hello.impl;
...
import com.lightbend.lagom.maven_archetype_lagom_java.hello.api.GreetingMessage;
import com.lightbend.lagom.maven_archetype_lagom_java.hello.api.HelloService;
import com.lightbend.lagom.maven_archetype_lagom_java.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<com.lightbend.lagom.maven_archetype_lagom_java.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      com.lightbend.lagom.maven_archetype_lagom_java.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new com.lightbend.lagom.maven_archetype_lagom_java.hello.api.HelloEvent.GreetingMessageChanged(
